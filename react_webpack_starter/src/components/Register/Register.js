                        ...
                        <div className="col-md-6">
                            <div className="register__form_upload">
                                ...
                                <div className="register__form_upload-div">
                                    <span>Upload</span>
                                    <input id="inputFile" type="file" className="register__form_upload-div_input" name="upload-input"/>
                                </div>
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="register__form_submit">
                                <Btn url={'#'} class={'btn btn__submit'} value="Sign Up" onClick={this.addUser} />
                            </div>
                        </div>
                    </div>
                </form>
